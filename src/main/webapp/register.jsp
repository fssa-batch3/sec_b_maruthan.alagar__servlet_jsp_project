		...
		<div class="tab">
			...
			<div class="content">
				...
				<input class="lists" id="license_number" name="license_number"
					...
					maxlength="14"   value="<%=(newShop != null) ? newShop.getLicenseNumber() : "23784894098987"%>"
			...
			<div class="content">
				<label class="forms">Phone Number<span id="imp"> *</span></label> <input
					...
					pattern="^[6789]\d{9,9}$" maxlength="10"  value="<%=(newShop != null) ? newShop.getPhoneNumber() : "6108419159"%>"
			...
			<div class="content">
				<label class="forms">E-Mail Address<span id="imp"> *</span>
					...
					value="<%=(newShop != null) ? newShop.getEmail() : "evergreensupermarket@gmail.com"%>"
		...
		<div class="tab">
			...
			<div class="content">
				<label class="forms"> Create New Password<span id="imp">
					...
					type="password" placeholder="Abcd@123"  value="<%=(newShop != null) ? newShop.getPassword() : "Ever@1234"%>"
			...
			<div class="content">
				<label class="forms">Re-Enter Password<span id="imp">
					...
					value="<%=(newShop != null) ? newShop.getPassword() : "Ever@1234"%>" placeholder="Abcd@123" required>
		...
		<div class="tab">
			...
			<div class="content">
				<label class="forms">GSTIN Number<span id="imp"> *</span></label> <input
					...
					value="<%=(newShop != null) ? newShop.getGSTNNumber() : "33CCCEV7409R1Z8"%>"
			...
			<div class="content">
				<label class="forms">Address<span id="imp"> *</span></label> <input
					...
					value="<%=(newShop != null) ? newShop.getAddress() : "789 Nheru St, Pudukkottai"%>" name="address"
			...
			<div class="content">
				<label class="forms">Owner name<span id="imp"> *</span></label> <input
					class="lists" id="owner_name" type="text" value="<%=(newShop != null) ? newShop.getOwnerName() : "Rahu Raman"%>"
			...
			<div class="content">
				<label class="forms">Print Name(For Bill)<span id="imp">
					...
					pattern="^[a-zA-Z-\s]+$" value="<%=(newShop != null) ? newShop.getPrintName() : "Evergreen"%>" name="print_name"
