...
<body>
	...
	<form id="cus_form">
		<div class="namebar">
			...
			<div id="top">
				...
				<div>
					<a><button id="add_button">+</button></a>
				</div>
	...
	var productListJson = '<%=request.getAttribute("productListJson")%>'; // Replace with your actual way of getting the data
	var userListJson = '<%=request.getAttribute("userListJson")%>
		'; // Replace with your actual way of getting the data
	...
	<a id="mark_back" href="../bills"><h3 class="top_back">&#x2190;
			Back to Home</h3></a>
</body>
</html>
